...
if (!$con) {
    ...
    if (isset($_POST['submit'])) 
    {
        ...
        $sql="INSERT INTO `traveller`(`traveller_id`,`traveller_name`,`email`,`age`,`phone`,`act_id`, `act_name`, `price`) VALUES ('','$traveller_name','$email','$age','$phone','$_SESSION[act_id]', '$_SESSION[act_name]', '$_SESSION[price]')";
