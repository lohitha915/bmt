...
$sql="INSERT INTO `userbus` (`fromloc`, `toloc`, `ddate`, `traveller`, `class`) VALUES ('$fromloc', '$toloc', '$ddate', '$traveller', '$class')";
...
<body class="body">
    <div class="container"><!--container-->
        ...
        <form class="form-group mr-sm-20 p-sm-20" action="userbus.php" method="post"><!--form-->
            <h1 class="display-6  text-center">BUS Booking Form</h1>
            ...
            <div id="input"><!--input-->
               ...
               <div class="col-sm-10">
                <select  id="input-group" name="class" style="background: black;">
                    ...
                    <option value="First Class">Semi sleeper</option>
                </select>
            </div>
                </div><!--input-->
        <div class="col-sm-10">
                ...
                <div class="col-sm-10">
                <button type="submit" name="submit" class="btn btn-warning text-white">Search bus</button>
