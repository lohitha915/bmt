...
$query = "SELECT * FROM `admtrain` WHERE `departure`= '$_SESSION[fromloc]' and `destination`= '$_SESSION[toloc]' and `ddate`='$_SESSION[ddate]'";
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <?php
                        echo '<td><button type="submit" name="booknow"class="btn btn-primary"><a href="detailstrain.php" class="text-light">Book Now</a></button></tr>';
                    }
