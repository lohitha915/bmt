    ...
    <div class="box1 ">
            ...
            <form method="post" action="hotelbook.php">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                    <div class="col-sm-10">
                        <label for="phone" class="form-label"><p class="p-0 m-0">Number of Rooms</p></label>
                        <input class="form-control" type="number"  name="rooms" required>
                    </div>
                    </div>
                    <div class="mb-3 row">
                    <div class="col-sm-10">
                        <label for="phone" class="form-label"><p class="p-0 m-0">Number of days</p></label>
...
if (!$con) {
    ...
    if (isset($_POST['submit'])) 
    {
        ...
        $rooms=$_POST['rooms'];
        $days=$_POST['days'];
        $fair=$_SESSION['price']*$rooms*$days;

        $sql="INSERT INTO `traveller`(`traveller_id`,`traveller_name`,`email`,`age`,`phone`,`hotel_id`, `hotel_name`,`rooms`,`days`,`price`) VALUES ('','$traveller_name','$email','$age','$phone','$_SESSION[hotel_id]', '$_SESSION[hotel_name]','$rooms','$days', '$fair')";
