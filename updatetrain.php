...
$updateid=$_GET['id'];
$sql1="SELECT * FROM `admtrain` WHERE sl_no=$updateid";
...
$seats=$_POST['seats'];
$price=$_POST['price'];
$sql="UPDATE `admtrain` set `trainno`='$trainno', `train_name`='$train_name', `departure`='$departure' ,`destination`='$destination',`ddate`='$ddate',`dtime`='$dtime',`seats`='$seats',`price`='$price'  where `sl_no`='$updateid'";
  ...
  <form method="post">
    <div id="form" class="form m-auto m-md-5 p-md-5 bg-dark">
      ...
      <div class="row mb-3 text-white">
        ...
        <div class="col-sm-10">
          <input type="number" name='trainno' class="form-control" id="flno" value="<?php echo $trainno?>" required>
        </div>
      </div>
      <div class="row mb-3 text-white">
        ...
        <div class="col-sm-10">
          <input type="text" name='train_name' class="form-control" value="<?php echo $train_name?>"required>
        </div>
      </div>
      ...
      <button type="submit" class="btn btn-primary" name='updatetrain'>Update Train</button>
