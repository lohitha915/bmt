...
if (isset($_POST['submit'])) 
{
    ...
    $sql = "INSERT INTO `traveller`(`traveller_id`,`traveller_name`,`email`,`age`,`phone`,`flno`, `flight_name`, `departure`, `destination`, `ddate`,`dtime`,`class`,`price`) VALUES ('','$traveller_name','$email','$age','$phone','$_SESSION[flno]', '$_SESSION[flight_name]', '$_SESSION[fromloc]', '$_SESSION[toloc]', '$_SESSION[ddate]','$_SESSION[dtime]','$_SESSION[class]','$_SESSION[price]')";
            ...
            <form method="post" action="details.php">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                      ...
                      <button type="submit" class="btn btn-primary" name="submit"><a href="booking.php" class="text-light">Submit</a></button>
