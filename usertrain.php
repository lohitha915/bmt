...
$sql="INSERT INTO `usertrain` (`fromloc`, `toloc`, `ddate`, `traveller`, `class`) VALUES ('$fromloc', '$toloc', '$ddate', '$traveller', '$class')";
...
if($insert)
{
    ...
    header('location:usertrain2.php');
...
<body class="body">
    <div class="container"><!--container-->
        ...
        <form class="form-group mr-sm-20 p-sm-20" action="usertrain.php" method="post"><!--form-->
            <h1 class="display-6  text-center">TRAIN Booking Form</h1>
            ...
            <div id="input"><!--input-->
               ...
               <div class="col-sm-10">
                <select  id="input-group" name="class" style="background: black;">
                    ...
                    <option value="Economy Class">AC sleeper</option>
                    <option value="Business Class">Non-Ac sleeper</option>
                    <option value="First Class">Second class</option>
                </select>
            </div>
                </div><!--input-->
        <div class="col-sm-10">
                ...
                <div class="col-sm-10">
                <button type="submit" name="submit" class="btn btn-warning text-white">Search train</button>
