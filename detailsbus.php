...
if (isset($_POST['submit'])) 
{
    ...
    $sql = "INSERT INTO `traveller`(`traveller_id`,`traveller_name`,`email`,`age`,`phone`,`busno`, `bus_name`, `departure`, `destination`, `ddate`,`dtime`,`class`,`price`) VALUES ('','$traveller_name','$email','$age','$phone','$_SESSION[busno]', '$_SESSION[bus_name]', '$_SESSION[fromloc]', '$_SESSION[toloc]', '$_SESSION[ddate]','$_SESSION[dtime]','$_SESSION[class]','$_SESSION[price]')";
    $result = mysqli_query($con, $sql);
    if($result)
    {
        $_SESSION['traveller_name']=$traveller_name;  
    }
...
<body>
    ...
    <div class="box1 ">
            ...
            <form method="post" action="detailsbus.php">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                      ...
                      <button type="submit" class="btn btn-primary" name="submit"><a href="bookingbus.php" class="text-light">Submit</a></button>
