        ...
        <div class="maincontainer row row cols-md-2">
            <div class="iconsContainer m-md-5 col">
                <div class="icons m-md-5 p-md-5  row row-cols-1 row-cols-md-2 row-cols-lg-3">
                    <div class="text">
                        Flights
                        <div class="icon col m-md-auto"><a href="admin.php" class="text-dark"><i
                                    class="bi bi-airplane-engines-fill fa-4x "></i></a>
                        </div>
                    </div>
                    <div class="text">
                        Buses
                        <div class="icon col m-md-auto"><a href="admbus.php" class="text-dark"><i
                                    class="bi bi-bus-front-fill fa-4x"></i></a>
                        </div>
                    </div>
                    <div class="text">
                        Trains
                        <div class="icon col m-md-auto"><a href="admtrain.php" class="text-dark">
